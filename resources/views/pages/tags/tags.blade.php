<x-app-layout>
    ...
    <div class="container">
        ...
        @if($errors->any())
            ...
            @endforeach
        @endif
        <a class="btn btn-primary mb-4" href="{{ route('newTag') }}" role="button">Добавить</a>
        <div class="row">
            <div class="col-md-6">
                <ul class="list-group mb-4">
                    ...
                    @foreach($tags as $tag)
                        <div class="tag-div" id="{{ $tag->id }}">
                            <li class="list-group-item list-group-item-action d-flex justify-content-between">
                            <span class="me-3">
                                {{ $tag->name }}
                            </span>
                                <span class="text-nowrap">
                            <a href="{{ route('viewTag', $tag) }}" class="text-decoration-none me-2">
                        ...
                        <a id="{{ $tag->id }}" href="#exampleModalToggle"
